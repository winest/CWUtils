...
class CCmdArgsParser
{
    ...
    private :
        ...
        std::map< std::string , std::string , CaseInsensitiveCmp > m_mapNamedArgs;
        std::vector< std::string > m_vecUnnamedArgs;

        std::string m_strGeneralUsage;
        std::map< std::string , CmdArgProperty , CaseInsensitiveCmp > m_mapNamedArgsProp;
};
