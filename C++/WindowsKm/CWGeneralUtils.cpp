...
//     None.
// =============================================================================
static void __cdecl initterm( _PVFV * pfbegin, _PVFV * pfend )
{
...
// =============================================================================
int __cdecl atexit( _PVFV pfCallOnExit )
{
    int iRet = -1;
    if ( pfCallOnExit )
    {
        ...
        //
        PCALL_ON_EXIT_INFO pCallOnExitInfo =
            (PCALL_ON_EXIT_INFO)ExAllocatePoolWithTag( NonPagedPool, sizeof( CALL_ON_EXIT_INFO ), GOBJECT_MEM_TAG );
        if ( pCallOnExitInfo )
        {
