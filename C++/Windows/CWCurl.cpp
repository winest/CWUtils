...
CURLcode CCurl::Get( IN CONST CHAR * aUrl , IN CONST CHAR * aParams , OUT CurlResponse * aResponse , OPTIONAL IN UINT aTimeout )
{
...
CURLcode CCurl::Post( IN CONST CHAR * aUrl , IN CONST CHAR * aParams , IN INT aParamSize , OUT CurlResponse * aResponse , OPTIONAL IN UINT aTimeout )
{
    wprintf_s( L"aUrl=%hs, aParams=%hs, aParamSize=%d, aResponse=0x%p, aTimeout=%u\n" , aUrl , aParams , aParamSize , aResponse , aTimeout );
    _ASSERT( aUrl );
    if ( NULL != aResponse )
    {
        aResponse->strData.clear();
...
CURLcode CCurl::Post( IN CONST CHAR * aUrl , IN CONST CHAR * aParams , OUT CurlResponse * aResponse , OPTIONAL IN UINT aTimeout )
{
    return this->Post( aUrl , aParams , -1 , aResponse , aTimeout );
}


CURLcode CCurl::UploadFile( IN CONST CHAR * aUrl , IN CONST CHAR * aFilePath , OUT CurlResponse * aResponse , OPTIONAL IN UINT aTimeout )
{
...
CURLcode CCurl::UploadFile( IN CONST CHAR * aUrl , IN CONST WCHAR * aFilePath , OUT CurlResponse * aResponse , OPTIONAL IN UINT aTimeout )
{
    ...
    curl_formadd( &post , &last , CURLFORM_COPYNAME , "file" , CURLFORM_BUFFER , "file" , CURLFORM_BUFFERLENGTH , strContent.size() , CURLFORM_BUFFERPTR , strContent.c_str() , CURLFORM_END );
