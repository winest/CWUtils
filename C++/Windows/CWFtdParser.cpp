...
BOOL CFtdParser::Init( FtdRecordParsedCbk aRecordParsedCbk , VOID * aRecordParsedCbkCtx )
{
    ...
    do 
    {
        m_mapFtdPartIdInfo[FTD_PART_ID_HDR_TYPE]             = FtdPartIdInfo( FTD_PART_ID_HDR_TYPE             , "FTD_PART_ID_HDR_TYPE"             , FTD_PART_DATA_TYPE_NUM , sizeof(FtdHdr::uFtdType)             , FTD_PART_ID_HDR_EXTHDR_SIZE );
        m_mapFtdPartIdInfo[FTD_PART_ID_HDR_EXTHDR_SIZE]      = FtdPartIdInfo( FTD_PART_ID_HDR_EXTHDR_SIZE      , "FTD_PART_ID_HDR_EXTHDR_SIZE"      , FTD_PART_DATA_TYPE_NUM , sizeof(FtdHdr::uFtdExtHdrSize)       , FTD_PART_ID_HDR_FTDC_SIZE );
        m_mapFtdPartIdInfo[FTD_PART_ID_HDR_FTDC_SIZE]        = FtdPartIdInfo( FTD_PART_ID_HDR_FTDC_SIZE        , "FTD_PART_ID_HDR_FTDC_SIZE"        , FTD_PART_DATA_TYPE_NUM , sizeof(FtdHdr::uFtdcSize)            , FTD_PART_ID_EXTHDR_TAG_TYPE );

        m_mapFtdPartIdInfo[FTD_PART_ID_EXTHDR_TAG_TYPE]      = FtdPartIdInfo( FTD_PART_ID_EXTHDR_TAG_TYPE      , "FTD_PART_ID_EXTHDR_TAG_TYPE"      , FTD_PART_DATA_TYPE_NUM , sizeof(FtdExtHdrTag::uFtdTagType)    , FTD_PART_ID_EXTHDR_TAG_SIZE );
        m_mapFtdPartIdInfo[FTD_PART_ID_EXTHDR_TAG_SIZE]      = FtdPartIdInfo( FTD_PART_ID_EXTHDR_TAG_SIZE      , "FTD_PART_ID_EXTHDR_TAG_SIZE"      , FTD_PART_DATA_TYPE_NUM , sizeof(FtdExtHdrTag::uFtdTagSize)    , FTD_PART_ID_EXTHDR_TAG_CONTENT );
        m_mapFtdPartIdInfo[FTD_PART_ID_EXTHDR_TAG_CONTENT]   = FtdPartIdInfo( FTD_PART_ID_EXTHDR_TAG_CONTENT   , "FTD_PART_ID_EXTHDR_TAG_CONTENT"   , FTD_PART_DATA_TYPE_RAW , -1                                   , FTD_PART_ID_EXTHDR_TAG_TYPE );

        m_mapFtdPartIdInfo[FTD_PART_ID_FTDCHDR1_VERSION]     = FtdPartIdInfo( FTD_PART_ID_FTDCHDR1_VERSION     , "FTD_PART_ID_FTDCHDR1_VERSION"     , FTD_PART_DATA_TYPE_NUM , sizeof(FtdcHdr1::uVersion)           , FTD_PART_ID_FTDCHDR1_TYPE );
        m_mapFtdPartIdInfo[FTD_PART_ID_FTDCHDR1_TYPE]        = FtdPartIdInfo( FTD_PART_ID_FTDCHDR1_TYPE        , "FTD_PART_ID_FTDCHDR1_TYPE"        , FTD_PART_DATA_TYPE_NUM , sizeof(FtdcHdr1::uType)              , FTD_PART_ID_FTDCHDR1_UNKNOWN1 );
        m_mapFtdPartIdInfo[FTD_PART_ID_FTDCHDR1_UNKNOWN1]    = FtdPartIdInfo( FTD_PART_ID_FTDCHDR1_UNKNOWN1    , "FTD_PART_ID_FTDCHDR1_UNKNOWN1"    , FTD_PART_DATA_TYPE_NUM , sizeof(FtdcHdr1::uUnknown1)          , FTD_PART_ID_FTDCHDR1_CHAIN_TYPE );
        m_mapFtdPartIdInfo[FTD_PART_ID_FTDCHDR1_CHAIN_TYPE]  = FtdPartIdInfo( FTD_PART_ID_FTDCHDR1_CHAIN_TYPE  , "FTD_PART_ID_FTDCHDR1_CHAIN_TYPE"  , FTD_PART_DATA_TYPE_NUM , sizeof(FtdcHdr1::uChainType)         , FTD_PART_ID_FTDCHDR2_SEQ_SERIES );

        m_mapFtdPartIdInfo[FTD_PART_ID_FTDCHDR2_SEQ_SERIES]  = FtdPartIdInfo( FTD_PART_ID_FTDCHDR2_SEQ_SERIES  , "FTD_PART_ID_FTDCHDR2_SEQ_SERIES"  , FTD_PART_DATA_TYPE_NUM , sizeof(FtdcHdr2::uSeqSeries)         , FTD_PART_ID_FTDCHDR2_SEQ_NUM );
        m_mapFtdPartIdInfo[FTD_PART_ID_FTDCHDR2_SEQ_NUM]     = FtdPartIdInfo( FTD_PART_ID_FTDCHDR2_SEQ_NUM     , "FTD_PART_ID_FTDCHDR2_SEQ_NUM"     , FTD_PART_DATA_TYPE_NUM , sizeof(FtdcHdr2::uSeqNum)            , FTD_PART_ID_FTDCHDR2_UNKNOWN1 );
        m_mapFtdPartIdInfo[FTD_PART_ID_FTDCHDR2_UNKNOWN1]    = FtdPartIdInfo( FTD_PART_ID_FTDCHDR2_UNKNOWN1    , "FTD_PART_ID_FTDCHDR2_UNKNOWN1"    , FTD_PART_DATA_TYPE_NUM , sizeof(FtdcHdr2::uUnknown1)          , FTD_PART_ID_FTDCHDR2_FIELD_COUNT );
        m_mapFtdPartIdInfo[FTD_PART_ID_FTDCHDR2_FIELD_COUNT] = FtdPartIdInfo( FTD_PART_ID_FTDCHDR2_FIELD_COUNT , "FTD_PART_ID_FTDCHDR2_FIELD_COUNT" , FTD_PART_DATA_TYPE_NUM , sizeof(FtdcHdr2::uFieldCount)        , FTD_PART_ID_FTDCHDR2_FIELD_SIZE );
        m_mapFtdPartIdInfo[FTD_PART_ID_FTDCHDR2_FIELD_SIZE]  = FtdPartIdInfo( FTD_PART_ID_FTDCHDR2_FIELD_SIZE  , "FTD_PART_ID_FTDCHDR2_FIELD_SIZE"  , FTD_PART_DATA_TYPE_NUM , sizeof(FtdcHdr2::uFieldSize)         , FTD_PART_ID_FTDCHDR2_REQ_ID );
        m_mapFtdPartIdInfo[FTD_PART_ID_FTDCHDR2_REQ_ID]      = FtdPartIdInfo( FTD_PART_ID_FTDCHDR2_REQ_ID      , "FTD_PART_ID_FTDCHDR2_REQ_ID"      , FTD_PART_DATA_TYPE_NUM , sizeof(FtdcHdr2::uReqId)             , FTD_PART_ID_FTDC_FIELD_ID );
        
        m_mapFtdPartIdInfo[FTD_PART_ID_FTDC_FIELD_ID]        = FtdPartIdInfo( FTD_PART_ID_FTDC_FIELD_ID        , "FTD_PART_ID_FTDC_FIELD_ID"        , FTD_PART_DATA_TYPE_NUM , sizeof(FtdcField::uFieldId)          , FTD_PART_ID_FTDC_FIELD_SIZE );
        m_mapFtdPartIdInfo[FTD_PART_ID_FTDC_FIELD_SIZE]      = FtdPartIdInfo( FTD_PART_ID_FTDC_FIELD_SIZE      , "FTD_PART_ID_FTDC_FIELD_SIZE"      , FTD_PART_DATA_TYPE_NUM , sizeof(FtdcField::uFieldSize)        , FTD_PART_ID_FTDC_FIELD_CONTENT );
        m_mapFtdPartIdInfo[FTD_PART_ID_FTDC_FIELD_CONTENT]   = FtdPartIdInfo( FTD_PART_ID_FTDC_FIELD_CONTENT   , "FTD_PART_ID_FTDC_FIELD_CONTENT"   , FTD_PART_DATA_TYPE_RAW , -1                                   , FTD_PART_ID_FTDC_FIELD_ID );
...
FtdParserErr CFtdParser::ParseFtdHdr( ParseParam * aParam )
{
    ...
    DbgOut( VERB , DBG_PROTOHANDLER , "Leave. uParserRet=%u, uPartId=%u" , uParserRet , aParam->pSubPartParsedInfo->uPartId );
    return uParserRet;
}
...
FtdParserErr CFtdParser::ParseFtdcHdr1( ParseParam * aParam )
{
    ...
    do 
    {
        ...
        uParserRet = this->DoParse( aParam , uFtdcHdr1Size , FTD_PART_ID_FTDCHDR1_BEGIN , FTD_PART_ID_FTDCHDR1_END , FALSE );
...
FtdParserErr CFtdParser::ParseFtdcHdr2( ParseParam * aParam )
{
    ...
    do 
    {
        ...
        UINT16 uFtdcCompressedSize = ( 0 < uFtdcSize ) ? uFtdcSize - sizeof(FtdcHdr1) : 0;    //Since FtdcHdr1 won't be compressed
        ...
        if ( aParam->pFieldMgr->IsFlagSet(FTD_FLAG_FTDC_COMPRESSED) && 0 < uFtdcCompressedSize )
        {
                ...
                DbgOut( VERB , DBG_PROTOHANDLER , "Decompressed 0x%X/0x%X: %!HEXDUMP!" ,
                        aParam->pMainPartParsedInfo->uCompressionParsedSize , uFtdcCompressedSize ,
                        WppHexDump(aParam->pMainPartParsedInfo->vecDecompressedBuf.data() , aParam->pMainPartParsedInfo->vecDecompressedBuf.size())
                      );
            #elif defined ( USE_G3LOG )
                string strHexDump;
                CWUtils::ToHexDump( aParam->pMainPartParsedInfo->vecDecompressedBuf.data() , aParam->pMainPartParsedInfo->vecDecompressedBuf.size() , strHexDump , "|" , 32 );
        ...
        uParserRet = this->DoParse( aParam , uFtdcHdr2Size , FTD_PART_ID_FTDCHDR2_BEGIN , FTD_PART_ID_FTDCHDR2_END , FALSE );
    } while ( 0 );
...
FtdParserErr CFtdParser::DoParse( ParseParam * aParam , UINT aMainPartSize , 
                                  FtdPartId aBeginPartId , FtdPartId aEndPartId ,
                                  BOOL aUseDecompessedBuf )
{
    ...
    DbgOut( VERB , DBG_PROTOHANDLER , "aUseDecompessedBuf=%d, pCurrBuf=0x%p, uCurrBufSize=0x%X" , aUseDecompessedBuf , pCurrBuf , uCurrBufSize );
    ...
    do 
    {
        while ( 0 < uCurrBufSize && aParam->pMainPartParsedInfo->uMainPartParsedSize < aMainPartSize )
        {
            ...
            #if defined ( USE_WPP )
                DbgOut( VERB , DBG_PROTOHANDLER , "Parsing %!FTDPARTID!|%!FTDPARTID!|%!FTDPARTID!=0x%X/0x%X" , 
                        aBeginPartId , aParam->pSubPartParsedInfo->uPartId , aEndPartId ,
                        aParam->pMainPartParsedInfo->uMainPartParsedSize , aMainPartSize );
            #elif defined ( USE_G3LOG )
                DbgOut( VERB , DBG_PROTOHANDLER , "Parsing %u|%u|%u=0x%X/0x%X" , 
                        aBeginPartId , aParam->pSubPartParsedInfo->uPartId , aEndPartId ,
                        aParam->pMainPartParsedInfo->uMainPartParsedSize , aMainPartSize );
            #endif
            ...
            {
                aParam->pSubPartParsedInfo->vecBuf.insert( aParam->pSubPartParsedInfo->vecBuf.end() , pCurrBuf , pCurrBuf + uLeftSize );
            
                FtdPartId uPartId;
                for ( uPartId = (FtdPartId)(aBeginPartId + 1) ; uPartId < aEndPartId ; uPartId = (FtdPartId)(uPartId + 1) )
                {
                    if ( aParam->pSubPartParsedInfo->uPartId == uPartId )
                    {
                        ...
                        {
                            UINT uData = Ntoh( aParam->pSubPartParsedInfo->vecBuf.data() , aParam->pSubPartParsedInfo->vecBuf.size() );
                        ...
                        else
                        {
                            ...
                            #if defined ( USE_WPP )
                                DbgOut( VERB , DBG_PROTOHANDLER , "Found %!FTDPARTID!, Value=%!HEXDUMP!" , pInfo->uPartId , WppHexDump(aParam->pSubPartParsedInfo->vecBuf.data(),aParam->pSubPartParsedInfo->vecBuf.size()) );
                            #elif defined ( USE_G3LOG )
                                string strHexDump;
                                CWUtils::ToHexDump( aParam->pSubPartParsedInfo->vecBuf.data() , aParam->pSubPartParsedInfo->vecBuf.size() , strHexDump , "|" , 32 );
                        ...
                        if ( aParam->pSubPartParsedInfo->uPartId == FTD_PART_ID_EXTHDR_TAG_CONTENT )
                        {
                            ...
                            {
                                aParam->pFieldMgr->GetRawPartValue( FTD_PART_ID_EXTHDR_TAG_CONTENT , tag.strFtdTagContent );
                            }
                        ...
                        else if ( aParam->pSubPartParsedInfo->uPartId == FTD_PART_ID_FTDC_FIELD_CONTENT )
                        {
                            ...
                            {
                                aParam->pFieldMgr->GetRawPartValue( FTD_PART_ID_FTDC_FIELD_CONTENT , field.strFieldContent );
                            }
            ...
            {
                aParam->pSubPartParsedInfo->vecBuf.insert( aParam->pSubPartParsedInfo->vecBuf.end() , pCurrBuf , pCurrBuf + uCurrBufSize );
        ...
        if ( aUseDecompessedBuf )
        {
            ...
            {
                aParam->pMainPartParsedInfo->vecDecompressedBuf.erase( aParam->pMainPartParsedInfo->vecDecompressedBuf.begin() , aParam->pMainPartParsedInfo->vecDecompressedBuf.begin() + uCurrParsedSize );
            }
        }
        else
        {
    ...
    #elif defined ( USE_G3LOG )
        DbgOut( VERB , DBG_PROTOHANDLER , "Leave. uParserRet=%u, uPartId=%u, uMainPartParsedSize=0x%X" , 
                uParserRet , aParam->pSubPartParsedInfo->uPartId , aParam->pMainPartParsedInfo->uMainPartParsedSize );
    #endif
    return uParserRet;
}
