...
VOID TestRc4()
{
    ...
    DbgOut( INFO, DBG_TEST, "%hs => %!HEXDUMP! => %hs", strOrg.c_str(),
            _WppHexDump( (const UCHAR *)strRc4Encoded.c_str(), strRc4Encoded.length() ), strRc4Decoded.c_str() );
    wprintf_s( L"\n========== TestRc4() Leave ==========\n" );
}
...
VOID TestRsa()
{
    ...
    UCHAR szKey1[] = {  };
    UCHAR szKey2[] = { 0x06, 0x02, 0x00, 0x00, 0x00, 0xA4, 0x00, 0x00, 0x52, 0x53, 0x41, 0x31, 0x00, 0x04, 0x00,
                       0x00, 0x01, 0x00, 0x01, 0x00, 0x03, 0x44, 0x68, 0x65, 0x47, 0xEA, 0x97, 0x70, 0x93, 0x1E,
                       0x26, 0x12, 0x9A, 0xC0, 0x62, 0xAF, 0x33, 0x5D, 0x5C, 0xF9, 0x47, 0x68, 0xBA, 0xCA, 0x92,
                       0x71, 0xD7, 0x19, 0xA3, 0x47, 0xB9, 0x2B, 0x1C, 0x15, 0xD7, 0xDB, 0x44, 0x5A, 0x33, 0x8B,
                       0x8F, 0xBE, 0x2A, 0x50, 0x22, 0x7A, 0x7F, 0x6B, 0x77, 0x89, 0xA3, 0x53, 0x74, 0x78, 0x60,
